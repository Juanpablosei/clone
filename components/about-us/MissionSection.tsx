...
export default function MissionSection({ image, label, title, content }: MissionSectionProps) {
  return (
    <section id="mission" className="mx-auto w-full max-w-[1600px] scroll-mt-24">
